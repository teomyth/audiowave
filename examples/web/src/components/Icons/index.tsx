...
// Audio Wave Icon Component - 5 vertical bars
export const AudioWaveIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// NPM Icon Component
export const NPMIcon = ({ size = 16 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="#CB3837" role="img" aria-label="NPM">
